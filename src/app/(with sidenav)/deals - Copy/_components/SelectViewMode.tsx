    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent className="p-0">
                ...
                <DropdownMenuItem className="flex border  w-full items-center gap-[20px] focus:bg-[#1D1DCE]/10 p-[12px]" onClick={() => router.push("/leads/?viewMode=listMode")} >
                    <List className="w-[30px]  h-[30px] stroke-[2.7]" />
                    List View
                </DropdownMenuItem>

                <DropdownMenuItem className="flex border  w-full items-center gap-[20px] focus:bg-[#1D1DCE]/10   p-[12px]" onClick={() => router.push("/leads/?viewMode=columnsMode")}>
                    <Kanban />
                    Kanban View
                </DropdownMenuItem>

                <DropdownMenuItem onClick={() => router.push("/leads/?viewMode=cardsMode")} className=" flex border  w-full items-center gap-[20px]   p-[12px] focus:bg-[#1D1DCE]/10">
                    <TitleView />
                    Title Leads
                </DropdownMenuItem>
            </DropdownMenuContent>
