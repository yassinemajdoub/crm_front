...
interface CardActivityProps {
    createdBy: string;
    createdAt: string; // Ensure createdAt is formatted as needed (e.g., "2024-07-09 14:30:00")
    body: string;
  }

export default function CardActivity() {
    return <div className="h-[300px] p-[20px] hover:border-black/30 hover:shadow-sm transition-colors border bg-white  shadow rounded-[20px]">
        ...
        <p className="mt-[8px] text-neutral-500 ">body bodybodybodybody</p>
